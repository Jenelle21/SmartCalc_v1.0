...
// TODO: переделать зависимость ползунков от строки - добавить поддержку дабла строке, и х10 в ползунке
...
// TODO: перекинуть инклуды в файлы кода, где нужно
// TODO: глянуть 29-31 число месяца в депозитном, нет выплат
// TODO: изменить инклуд сишки на ашку
